...
INSERT INTO clientes (region_id, nombre, apellido, email, create_at) VALUES(1, 'Andrés', 'Guzmán', 'andres@hotmail.com', '2018-01-01');
...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$RmdEsvEfhI7Rcm9f/uZXPebZVCcPC7ZXZwV51efAvMAp1rIaRAfPK',1, 'Jose', 'Vargas','jose@gmail.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('noAdmin','$2a$10$RmdEsvEfhI7Rcm9f/uZXPebZVCcPC7ZXZwV51efAvMAp1rIaRAfPK',1, 'No', 'Admin','NA@gmail.com');
...
INSERT INTO productos (nombre, precio, cantidad_disponible, create_at) VALUES('Camiseta Hulk', 20000,5, NOW());
INSERT INTO productos (nombre, precio, cantidad_disponible, create_at) VALUES('Vaso Spiderman', 5000,1, NOW());
INSERT INTO productos (nombre, precio, cantidad_disponible, create_at) VALUES('Comic Iron Man', 30000,100, NOW());
INSERT INTO productos (nombre, precio, cantidad_disponible, create_at) VALUES('Muñeco Super Man', 35000,2, NOW());
INSERT INTO productos (nombre, precio, cantidad_disponible, create_at) VALUES('Camiseta Mujer Maravilla', 20000,8, NOW());
INSERT INTO productos (nombre, precio, cantidad_disponible, create_at) VALUES('Bicicleta Thor', 259990,3, NOW());
INSERT INTO productos (nombre, precio, cantidad_disponible, create_at) VALUES('Accesorios Thanos', 69000,100, NOW());
